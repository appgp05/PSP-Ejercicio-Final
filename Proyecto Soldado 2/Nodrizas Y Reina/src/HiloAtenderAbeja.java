...
public class HiloAtenderAbeja extends Thread {
    ...
    private void atenderZangano(){
        try {
            ...
            System.out.println("Atendiendo Zangano - Buscando soldado");
            Soldado soldado = Main.buscarSoldado();
            System.out.println("Atendiendo Zangano - Soldado encontrado");
            System.out.println("Atendiendo Zangano - Soldado: " + soldado.getIdSoldado());

            dataOutputStream.writeInt(soldado.getIdSoldado());
    ...
    private void atenderRecolectora(){
        try {
            ...
            System.out.println("Atendiendo Recolectora - Buscando soldado");
            Soldado soldado = Main.buscarSoldado();
            System.out.println("Atendiendo Recolectora - Soldado encontrado");
            System.out.println("Atendiendo Recolectora - Soldado: " + soldado.getIdSoldado());

            System.out.println("Atendiendo Recolectora - Enviando con el soldado");
